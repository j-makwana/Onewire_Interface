...
# Path of this script: /home/jmakwana/workspace/onewire_system/_ide/scripts/debugger_onewire-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /home/jmakwana/workspace/onewire_system/_ide/scripts/debugger_onewire-default.tcl
# 
connect -url tcp:127.0.0.1:3121
targets -set -nocase -filter {name =~"APU*"}
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Zybo Z7 210351B481D0A" && level==0 && jtag_device_ctx=="jsn-Zybo Z7-210351B481D0A-23727093-0"}
